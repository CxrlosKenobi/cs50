...
{
    // TODO
    int minor = voter_count;
    for (int i = 0; i < candidate_count; i++)
    {
        if ((candidates[i].votes < minor) && (candidates[i].eliminated == false))
        {
            minor = candidates[i].votes;
        }
    }
    return minor;
}
...
bool is_tie(int minor)
{
    // TODO
    for (int i = 0; i < candidate_count; i++)
    {
        if ((candidates[i].eliminated == false) && (candidates[i].votes != minor))
        {
            return false;
        }
    }
...
void eliminate(int minor)
{
    // TODO
    for (int i = 0; i < candidate_count; i++)
    {
        if (candidates[i].votes == minor)
        {
